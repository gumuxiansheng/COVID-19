...
void WriteResults(const DataModel &data, const std::vector<int> &nodes_permutation, const std::string &file_name)
{
...
void VrpCapacity()
{
    ...
    covid19::WriteResults(data, round_solutions[min_index], out_file);
